...
class DemoController extends AbstractController
{
    ...
    public function authorizeAction(Request $request)
    {
        ...
        try {
            return $this->get(AuthorizationController::class)->indexAction($request);
        ...
        if ($request->isMethod('POST')) {
            $modelManagerFactory = $this->get('test.authbucket_oauth2.model_manager.factory');
    ...
    public function requestCodeAction(Request $request)
    {
        ...
        $userManager = $this->get('test.authbucket_oauth2.model_manager.factory')->getModelManager('user');
