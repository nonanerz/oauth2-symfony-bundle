...
namespace AuthBucket\Bundle\OAuth2Bundle\Tests\Model;
...
class InMemoryTest extends WebTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->set(
            'test.authbucket_oauth2.model_manager.factory',
            $container->get('authbucket_oauth2.model_manager.factory')
        );

        $accessTokenManager = $this->get('test.authbucket_oauth2.model_manager.factory')->getModelManager('access_token');
